...
"use strict";
var input = document.querySelectorAll('textarea#ptzWordTextBoy')[0],
  characterCount = document.querySelector('span#characterCount'),
...
input.addEventListener('keyup', function() {
  ...
  if (words) {
    ...
    for (var i = 0; i < sortedKeywords.length && i < 4; i++) {
      ...
      tr.innerHTML = "<td>" + sortedKeywords[i][0] + "</td><td>" + sortedKeywords[i][1] + "</td>";
      topKeywords.appendChild(tr);
    }
  }
